...
export const resendEmail = async () => await authPost(RequestUrls.resendEmail)
export const forgotPasswordEmailVerify = async (data) => await authPost(RequestUrls.forgotPasswordEmailVerify, data)
export const resetCode = async (data) => await authPost(RequestUrls.resetCode, data)